...
class QQmlConfiguration : public QObject, public QQmlParserStatus
{
    Q_OBJECT
...
public:
    explicit QQmlConfiguration(QObject *parent = 0);
    ~QQmlConfiguration();
...
private:
    Q_DISABLE_COPY(QQmlConfiguration)
...
QML_DECLARE_TYPE(QQmlConfiguration)
